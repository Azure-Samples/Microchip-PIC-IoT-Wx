...
At this point, you have verified your X.509 CA certificate in DPS. To link all the above sub-steps and understand why this step is significant, it is recommended to download and read [this document](https://docs.microsoft.com/en-us/azure/iot-dps/how-to-verify-certificates).
...
3.	Set the AzureIotPnpDps.X project as the main (currently focused/active) project by right-clicking on it and selecting "Set as Main Project"
...
1. Connect Azure IoT Explorer to IoT Hub by providing your IoT Hub’s
